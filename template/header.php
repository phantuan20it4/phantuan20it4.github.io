...
<div class="dropdown-content">
  <a class="alert-link"> '.$_SESSION["username"].'</a>
 ...
 ?>
      ...
      <?php
           error_reporting(0);
 if (isset($_SESSION['username'])) {
    echo '<a class="ui red  button" href="user/view/common/user_logout.php"><i class="sign-out icon"></i>Đăng xuất</a>';
 }
else if (isset($_SESSION['user_first_name'])) { 
...
if(isset($title) && $title == "List book" || isset($title) && $title == "Add new book"){
  echo '
    ...
    <div class="ui container">
     <a class="item" href="admin_book.php"><img class="ui mini rounded image" src="data:image/png;base64,"></a>
     <a class="item" href="admin_book.php" ><i class="home icon"></i>Trang chủ</a> 
     <a class="item" href="admin_add.php" ><i class="plus icon"></i> Thêm sách </a> 
     <div class="right menu">
        <div class="item"> 
